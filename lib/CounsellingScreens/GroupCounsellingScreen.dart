...
class _GroupCounsellingScreenState extends State<GroupCounsellingScreen> {
  ...
  Future<void> GetReviewsList() async {
    final response = await Userapi.getreviewlist("Group Counselling");
    if (response != null) {
      setState(() {
            ...
            child: Column(
              ...
              children: [
                Container(
                  ...
                  height: h * 0.3,
                  child: Image.asset(
                    "assets/Counciling/group_counsiling.jpeg",
                    fit: BoxFit.cover,
                  ),
                ),
                Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          if (reviews.length > 3)
            InkResponse(
              onTap: (){
                Navigator.push(context, MaterialPageRoute(builder: (context)=>ReviewListScreen(pageSource: "Group Counselling",)));
              },
              child: Padding(
