...
class BehavioralCounsellingScreen extends StatefulWidget {
  const BehavioralCounsellingScreen({super.key});

  @override
  State<BehavioralCounsellingScreen> createState() => _BehavioralCounsellingScreenState();
}

class _BehavioralCounsellingScreenState extends State<BehavioralCounsellingScreen> {
  bool showFocus = true;
  ...
  Future<void> GetReviewsList() async {
    final response = await Userapi.getreviewlist("Behavioral Counselling");
    if (response != null) {
      setState(() {
              ...
              children: [
                ...
                Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      Text(
                        "Behavioral Counseling Services at NeuroMitra",
                        style: TextStyle(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        _buildTextWithCircle(
                          ...
                          'We tailor our counseling sessions to address the specific behaviors and challenges you’re facing, ensuring that you receive targeted and effective support.',
                        ),
                        SizedBox(height: 10),
                        _buildTextWithCircle(
                          'Evidence-Based Techniques:',
                          'Our counselors use proven therapeutic approaches, such as Cognitive Behavioral Therapy (CBT), to help you develop healthier behaviors and thought patterns.',
                        ),
                        SizedBox(height: 10),
                        _buildTextWithCircle(
                          'Goal-Oriented Therapy:',
                          ' We work with you to set achievable goals and track your progress, helping you stay motivated and focused on your journey to change.',
                        ),
                        SizedBox(height: 10),
                        _buildTextWithCircle(
                          'Skill Development:',
                          ' Learn practical techniques to manage emotions, improve decision-making, and respond to situations in healthier ways.',
                        ),
                        // SizedBox(height: 10),
                        // _buildTextWithCircle(
                ...
                Visibility(
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        Text(
                          "Behavioral Counseling can be beneficial for individuals facing a variety of challenges, including:",
                          style: TextStyle(
                            color: Color(0xFF000000),
                            fontSize: 15,
                            fontWeight: FontWeight.w400,
                        ...
                        SizedBox(height: 20),
                        _buildTextWithCircle('Anxiety and Depression:',
                          'Difficulty with chewing and swallowing',
                        ),
                        SizedBox(height: 10),
                        _buildTextWithCircle('Stress Management:',
                          'Sensory aversions to certain food textures or flavors',
                        ),
                        SizedBox(height: 10),
                        _buildTextWithCircle('Anger Management:',
                          'Limited food variety and picky eating',
                        ),
                        SizedBox(height: 10),
                        _buildTextWithCircle('Behavioral Disorders:',
                          'Weight or growth concerns related to feeding difficulties',
                        ),
                        SizedBox(height: 10),
                        _buildTextWithCircle('Relationship Issues:',
                          'Improve communication, conflict resolution, and other behaviors that impact your relationships.',
                        ),
                      ],
                    ),
                  ),
              ...
              children: [
                ...
                Expanded(
                  ...
                  InkWell(onTap: (){
                    ...
                    Navigator.push(context, MaterialPageRoute(builder: (context)=>Bookappointment(pagesource:"Behavioral Counselling")));
                  },
                    child: Container(
                      height: h * 0.06,
      ...
      child: Column(
        ...
        children: [
          ...
          if (reviews.length > 3)
            InkResponse(
              onTap: (){
                Navigator.push(context, MaterialPageRoute(builder: (context)=>ReviewListScreen(pageSource: "Behavioral Counselling",)));
              },
              child: Padding(
