class AppointmentsModel {
  bool? status;
  List<AppointmentsList>? appointmentsList;

  AppointmentsModel({this.status, this.appointmentsList});
  ...
  AppointmentsModel.fromJson(Map<String, dynamic> json) {
    ...
    if (json['data'] != null) {
      ...
      json['data'].forEach((v) {
        appointmentsList!.add(new AppointmentsList.fromJson(v));
      });
    }
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.appointmentsList != null) {
      data['data'] = this.appointmentsList!.map((v) => v.toJson()).toList();
    }
    return data;
  }
}
