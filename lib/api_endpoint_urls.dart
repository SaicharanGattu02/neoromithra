class APIEndpointUrls {
  ...
  static const String addUserAddressApi ='${apiUrl}add_user_address';
  static const String updateUserAddress ='${apiUrl}update_user_address';
  static const String userAdressList ='${apiUrl}get_user_address_details';
