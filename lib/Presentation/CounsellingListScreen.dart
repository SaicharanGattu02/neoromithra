...
class CounsellingListScreen extends StatefulWidget {
  @override
  State<CounsellingListScreen> createState() => _CounsellingListScreenState();
}

class _CounsellingListScreenState extends State<CounsellingListScreen> {
                    ...
                    SliverPadding(
                      ...
                      sliver: SliverGrid(
                        ...
                        delegate: SliverChildBuilderDelegate(
                              (context, index) {
                            // Use dummy data for skeleton when loading
                            final counselling = homeProvider.counsellingslist[index];
                            return InkWell(
                          ...
                          childCount: homeProvider.isLoading
                              ? 4 // Show 4 skeleton items during loading
                              : homeProvider.counsellingslist.length,
                        ),
                      ),
                    ),
                  ],
