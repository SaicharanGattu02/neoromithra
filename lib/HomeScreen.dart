  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        leadingWidth: 0, // Ensures no space is allocated for the leading widget
        backgroundColor: Colors.white,
                  ...
                  Container(
                    ...
                    child:ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        return InkWell(
                              onTap: () => _navigateToDetails(context, item['text']!),
                            child: Container(
                            width: 170,
                            padding: EdgeInsets.all(8), // Padding inside the item container
                            child: Column(
                  ...
                  Container(
                    ...
                    ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        return
                          InkWell(
                            onTap: () => _onCounsellingTap(context, item['text']!),
                            child: Container(
                            width: 170,
                            padding: EdgeInsets.all(8), // Padding inside the item container
                            child: Column(
